...
// Update updates a given ent.Guest and saves the changes to the database.
func (h GuestHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Save the data.
	b := h.client.Guest.UpdateOneID(id)
	if d.Name != nil {
		b.SetName(*d.Name)
	}
	if d.Email != nil {
	...
	if err != nil {
		...
		case ent.IsNotSingular(err):
			...
			BadRequest(w, msg)
		default:
			l.Error("could-not-update-guest", zap.Error(err), zap.Int("id", id))
